        ...
        <div className='text-center'>
            <div className='flex flex-col gap-5 my-10'>
                <div className='text-center mx-auto'>
                    <div className="text-[red] px-4 py-2 rounded-full bg-gray-100 font-medium" >Gwcet Job & Internship Portal</div>
                </div>
                <div>
                    <h1 className='text-5xl font-bold'>Search, Apply & <br /> Get Your <span className='text-[#255691]'>Dream Job</span></h1>
                </div>
                <div>
                ...
                <div className='flex w-[40%] shadow-lg border pl-3 border-gray-200 rounded-full items-center gap-4 mx-auto'>
                    ...
                    />
                    <Button onClick={searchJobHandler} className='rounded-r-full bg-[#255691]'>
